...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <div class="pagetitle m-3 breadcrumbItems">
        <h1>Dashboard</h1>
      </div>
    </div><!-- End Logo -->
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <div class="d-flex">
              ...
              <span class="d-none d-md-block dropdown-toggle ps-2 agent_name ">Unknown</span>
            </div>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu  dropdown-menu-lg-start profile ">
            <li class="dropdown-header">
              <h6 class="agent_name"><b>Unknown</b></h6>
              <span id="agent_role">Role</span>
            </li>
            ...
            <li class="d-flex">
              ...
              <div class="m-2 p-1">
                <p id="agent_username">username</p>
                <p id="agent_id">id</p>
                <p id="agent_mob">0000</p>
                <p id="agent_status">Active</p>
              </div>
            </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle MobileSize">
      <h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                ...
                <a id="open">
                  <div class="card-body">
                    <h5 class="card-title">Open Tokens</h5>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        <h6 id="open_tickets_count">
                          <img class="img-fluid loader-gif" width="50" src="assets/images/loader.gif" alt="--">
                        </h6>
            ...
            <div class="col-xxl-3 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <a id="close">
                  <div class="card-body">
                    <h5 class="card-title">Closed Tokens </h5>
                    <div class="d-flex align-items-center">
                      <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                        <i class="bi bi-person-check-fill"></i>
                      </div>
                      <div class="ps-3">
                        <h6 id="closed_tickets_count">
                          <img class="img-fluid loader-gif" width="50" src="assets/images/loader.gif" alt="--">
